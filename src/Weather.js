...
const Temp = () => {
  ...
  return (
   ...
   <div class="container flex flex-row items-center justify-center h-screen">
	<div
		class="card mb-5  min-w-sm max-w-sm border border-gray-100 bg-gray-50  transition-shadow test  shadow-lg hover:shadow-shadow-xl w-full bg-gray-600 text-purple-50 rounded-md">
